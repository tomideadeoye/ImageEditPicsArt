...
export const PhotoEditContextProvider = ({ children }) => {
	...
	const [uploadData, setUploadData] = useState({
		...
		format: "",
		image: null,
		image_url: oldData?.image_url ?? null, // Enter the URL of a public-facing image.
		...
		bg_color: null, // Can be a hexcolor code (e.g., #82d5fa, #fff) or a color name (e.g., blue). For semi-transparency, 4-/8-digit hexcodes are also supported (e.g., #18d4ff87). (If this parameter is present, the other bg_ parameters must be empty, besides bg_size).
